...
def editar_usuario(id_user):
    def editaDadosUsuario(
        entidade_usuario: Usuario, form: EditarUsuarioForm, usuario_logado: int
    ):
        ...
        entidade_usuario.setCamposBolsista(
            form.bolsista.data,
            form.tipo_bolsa.data,
            form.inicio_bolsa.data,
            form.fim_bolsa.data,
        )
    ...
    def validaEntidade_usuario(entidade_usuario: Usuario):
        ...
        if (entidade_usuario.id == app.config["ADMIN_PADRAO"]) and (
            int(current_user.get_id()) != app.config["ADMIN_PADRAO"]
        ):
            flash(
                "O administrador padrão só pode ser alterado por si próprio.", "warning"
            )
            return False
    ...
    if request.method == "POST":
        ...
        if (not validaDadosForm(form.email.data, request.form["emailAtual"])) or (
            not form.validate()
        ):
    ...
    return renderizaTemplate(
        form, entidade_usuario, id_user, current_user.id, app.config["ADMIN_PADRAO"]
    )
        ...
        if confirmacao != senha:
            ...
            if not (form.validate()):
                ...
                entidade_usuario = Usuario(
                    ...
                    criado=criado,
                    criadopor=current_user.get_id(),
                    cert_atuacao_DAJ=cert_atuacao_DAJ,
                ...
                entidade_usuario.setSenha(senha)
                entidade_usuario.setCamposBolsista(
                    bolsista, tipo_bolsa, inicio_bolsa, fim_bolsa
                )
...
def criar_usuarios():
    # Administrador
    admin_endereco = Endereco(
        logradouro="rua dos bobos",
        numero="0",
        complemento="uma casa que não tem nada",
        bairro="coqueiros",
        cep="31888450",
    ...
    admin = Usuario(
        ...
        nascimento="1999-04-19",
        telefone="12345567",
        celular="12345567",
        data_entrada="2020-05-05",
        data_saida="2020-05-06",
        criado=datetime.now(),
        criadopor=1,
        endereco_id=admin_endereco.id,
        endereco=admin_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
        suplente="teste",
        ferias="teste",
        status=True,
    )
    ...
    orientador = Usuario(
        ...
        criado=datetime.now(),
        criadopor=1,
        endereco_id=orientador_endereco.id,
        endereco=orientador_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
    ...
    colaborador_proj_endereco = Endereco(
        logradouro="rua dos bobos",
        numero="0",
        complemento="uma casa que não tem nada",
        bairro="coqueiros",
    ...
    colaborador_proj = Usuario(
        email="colaboradorprojetos@daj.com",
        senha="colabprojetos",
        urole="colab_proj",
        nome="Colaborador de Projeto",
        sexo="M",
        rg="23213329080",
        cpf="1234567890",
        profissao="teste",
        ...
        criado=datetime.now(),
        criadopor=1,
        endereco_id=colaborador_proj_endereco.id,
        endereco=colaborador_proj_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
    ...
    estagiario = Usuario(
        email="estagiariodireito@daj.com",
        senha="estagiario",
        urole="estag_direito",
        ...
        criado=datetime.now(),
        criadopor=1,
        endereco_id=estagiario_endereco.id,
        endereco=estagiario_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
    ...
    # Colaborador externo
    colaborador_ext_endereco = Endereco(
        logradouro="rua dos bobos",
        numero="0",
        complemento="uma casa que não tem nada",
        bairro="coqueiros",
    ...
    colaborador_ext = Usuario(
        email="colaboradorexterno@daj.com",
        senha="colabexterno",
        urole="colab_ext",
        ...
        criado=datetime.now(),
        criadopor=1,
        endereco_id=colaborador_ext_endereco.id,
        endereco=colaborador_ext_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
    ...
    professor = Usuario(
        ...
        criado=datetime.now(),
        criadopor=1,
        endereco_id=professor_endereco.id,
        endereco=professor_endereco,
        oab="teste123",
        obs="obs",
        matricula="123456743",
        horario_atendimento="17:00:00",
    ...
    db.session.add_all(
        [admin, orientador, colaborador_proj, estagiario, colaborador_ext, professor]
    )
    db.session.commit()
