...
def setValoresFormAtendido(entidade_atendido: Atendido, form: CadastroAtendidoForm):
    ...
    form.procurou_outro_local.data = (
        False if entidade_atendido.procurou_outro_local == "0" else True
    )
    ...
    form.pretende_constituir_pj.data = (
        False if entidade_atendido.pretende_constituir_pj == "0" else True
    )
...
def setDadosGeraisAssistido(entidade_assistido, form: TornarAssistidoForm):
    ...
    entidade_assistido.setCamposDoenca(
        ...
        form.pessoa_doente.data,
        form.pessoa_doente_obs.data,
        form.gastos_medicacao.data,
    )


def setDadosAssistidoPessoaJuridica(
    entidade_assistidoPessoaJuridica: AssistidoPessoaJuridica, form: TornarAssistidoForm
):
    ...
    entidade_assistidoPessoaJuridica.setQtd_funcionarios(
        entidade_assistidoPessoaJuridica.tem_funcionarios, form.qtd_funcionarios.data
    )
    entidade_assistidoPessoaJuridica.setCamposRegiao_sede(
        entidade_assistidoPessoaJuridica.sede_bh,
        form.regiao_sede_bh.data,
        form.regiao_sede_outros.data,
    )
