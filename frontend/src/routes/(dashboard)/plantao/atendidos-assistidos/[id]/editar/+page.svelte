	...
	<div class="max-w-5xl py-1">
		...
		<div class="space-y-8">
			<AtendidoForm
				...
				isCreateMode={false}
				{onError}
				hideSubmitButton={data.isAssistido}
			/>

			{#if data.isAssistido && data.assistidoForm}
				<div class="pt-6 border-t">
					<h2 class="text-2xl font-bold mb-6">Informações de Assistido</h2>
					<AssistidoForm data={data.assistidoForm} {onError} isAssistido={true} />
				</div>
			{/if}
		</div>
	</div>
