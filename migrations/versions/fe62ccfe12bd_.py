...
Revision ID: fe62ccfe12bd
Revises: 
Create Date: 2020-07-06 13:29:05.971359
...
def upgrade():
    ...
    sa.Column('repres_legal', sa.String(length=80, collation='latin1_general_ci'), nullable=True),
